...
//    .init(commentId: 10000, deleted: false, name: "Alice", permissions: [], postId: 10000, tags: [], text: "", type: .image, image: .init(placeholder: (1760, 1152), image: UIImage(named: "test.comment"))),
    .init(commentId: 10001, deleted: false, name: "Zombie Alice", permissions: [], postId: 10000, tags: [], text: "动态替换。Swift 编译器和运行时已全面嵌入到 Xcode 中，您可以随时构建和运行您的 app。您看到的设计画布不仅仅是近似用户界面——它就是您实时运行的 app。此外，借助 Swift 中新推出的“动态替换”功能，Xcode 可以直接在实时运行的 app 中替换编辑后的代码。  \n.init(font: .system(size: 16), paragraphSpacing: 3)", type: .text, image: nil),
