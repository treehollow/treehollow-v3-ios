...
class Login: ObservableObject {
    ...
    func checkEmail() {
        ...
        let request = EmailCheckRequest(configuration: .init(email: fullEmail, reCAPTCHAInfo: reCAPTCHAInfo, hollowConfig: config))
    ...
    func register() {
        ...
        let request = AccountCreationRequest(configuration: .init(email: fullEmail, password: originalPassword, validCode: emailVerificationCode, deviceToken: "placeholder", hollowConfig: config))
    ...
    func login() {
        ...
        let request = LoginRequest(configuration: .init(email: fullEmail, password: loginPassword, deviceToken: "placeholder", hollowConfig: config))
        request.performRequest(completion: { result, error in
            self.isLoading = false
